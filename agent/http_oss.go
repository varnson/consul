...
func init() {
	...
	registerEndpoint("/v1/acl/rolebindingrules", []string{"GET"}, (*HTTPServer).ACLRoleBindingRuleList)
	registerEndpoint("/v1/acl/rolebindingrule", []string{"PUT"}, (*HTTPServer).ACLRoleBindingRuleCreate)
	registerEndpoint("/v1/acl/rolebindingrule/", []string{"GET", "PUT", "DELETE"}, (*HTTPServer).ACLRoleBindingRuleCRUD)
